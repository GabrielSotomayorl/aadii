...
Esta política está inspirada en el proyecto **[GENIAL](https://lse-dsi.github.io/genial/)** (*GENerative AI Tools as a Catalyst for Learning*), una iniciativa de la London School of Economics (LSE) que investigó, con datos reales de chatlogs de más de 200 estudiantes en 7 cursos, cómo el uso de IA generativa afecta el proceso de aprendizaje en educación superior.

---

## ¿Qué está permitido?

El uso de herramientas de IA generativa está **permitido en todas las evaluaciones del curso**, con la excepción de la prueba solemne (ver más abajo). Esto incluye, pero no se limita a:
...
## Excepción: Prueba Solemne

Esta política **no aplica a la prueba solemne**, que es una evaluación de carácter individual y presencial. En esa instancia, **no está permitido el uso de herramientas de IA** ni de ningún recurso externo no autorizado explícitamente.
...
> *"El tono convincente y autoritario de los chatbots les daba incluso a los mejores estudiantes la impresión de que el output era preciso y verdadero."*
> — Sallai, Cardoso-Silva & Barreto, Blog GENIAL (LSE, 2024)

En el estudio GENIAL, varios estudiantes entregaron código generado por IA que corría perfectamente... pero que no resolvía el problema que se pedía. Lo más preocupante: no notaron la diferencia.
...
> *"Fui línea por línea a entender qué hacía cada parte del código que generé con IA... después de entregarlo."*
> — Estudiante participante en el proyecto GENIAL

### La evidencia del proyecto GENIAL

El proyecto GENIAL analizó los chatlogs de 220 estudiantes de cursos de estadística, ciencias de datos, gestión y políticas públicas en la LSE durante el año académico 2023-2024. Sus hallazgos más relevantes para este curso:
...
| | |
|:---|:---|
| **¿Está permitido usar IA?** | Sí, en todas las evaluaciones **excepto** la prueba solemne. |
