...
title: "<font style='font-size:1em;'>🗓️ Semana 06<br/>Análisis Factorial Exploratorio (AFE)</font>"
...
## Objetivos Específicos del AFE {.smaller}
...
## El Modelo Matemático del AFE (Conceptual) {.smaller}
...
## Etapas del Análisis Factorial Exploratorio {.smaller}
...
## 3. Multicolinealidad: El Test KMO {.smaller}
...
## 4. Normalidad Multivariante {.smaller}
...
## 5. Casos Perdidos y Atípicos {.smaller}
...
## 6. Estandarización de Variables {.smaller}
...
## Próximos Pasos {.smaller .dark-background}
