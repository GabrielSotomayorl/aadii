...
-   **Arraigo barrial** (*t02*): grado en que una persona siente que el barrio le pertenece y constituye parte de su identidad. La literatura anglosajona lo vincula al concepto de *sense of place* o apego al lugar (Lewicka, 2011).

-   **Cohesión barrial percibida** (*t03*): evaluación de la sociabilidad, cordialidad y disposición colaborativa de los vecinos. Refleja el capital social informal del vecindario (Sampson, Raudenbush & Earls, 1997; Putnam, 2000).
...
Descarga el archivo `.RData` y guárdalo en la subcarpeta `data/` de tu proyecto (o ajusta la ruta en el código según tu estructura de carpetas).
