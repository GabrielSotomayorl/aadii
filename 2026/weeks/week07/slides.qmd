...
title: "<font style='font-size:1em;'>🗓️ Semana 07<br/>Análisis Factorial Exploratorio II: Extracción, Rotación e Interpretación</font>"
...
## Criterio de Kaiser (Autovalores > 1) {.smaller}
...
**Desventaja:** Tiende a **sobreestimar** (extraer demasiados) o a veces **subestimar** el número de factores. Usar con precaución y junto a otros criterios.

## Gráfico de Sedimentación (Scree Plot) {.smaller}
...
![](img/sedimentacion.png){fig-align="center"}
...
## 3. Métodos de Extracción de Factores {.smaller}
...
## 4. Rotación Factorial: Hacia la Simplicidad  {.smaller}
...
## Tipos de Rotación Factorial {.smaller}
...
## La Matriz de Cargas Factoriales {.smaller}
...
![](img/no_rotado.jpg){fig-align="center" width="80%"}

## Interpretando la Matriz Factorial (Post-Rotación) {.smaller}
...
## Ejemplo de Matriz Rotada {.smaller}

![](img/rotado.jpg){fig-align="center" width="80%"}


## Ejemplo de Matriz Rotada {.smaller}

![](img/rotadodest.jpg){fig-align="center" width="80%"}
...
## Estadísticos de Ajuste Comunes (Principalmente para ML) {.smaller}
...
## ¿Qué son las Puntuaciones Factoriales? {.smaller}
...
## Uso de las Puntuaciones Factoriales {.smaller}
