...
## ¿Porqué es importante esto más allá de la academia? {.smaller}
...
## Configuración de chunks {.smaller}
...
engine -- Lenguaje de programación usado en el código (por defecto "R")
...
## Control de versiones/Git-hub {.smaller}
...
-   Piensa en el proceso completo (datos brutos -- datos procesados -- análisis -- reporte)
