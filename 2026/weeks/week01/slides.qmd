...
<figure>
    <img src="/figures/people/profesor.jpg" alt="Imagen de Gabriel Sotomayor" role="presentation" style="object-fit: cover;width:5em;height:5em;border-radius: 50%;font-size:1em;" class="img-responsive atto_image_button_text-bottom">
    <figcaption>
...
- Sociólogo (Universidad de Chile) y MSc en Sociología (LSE).
- Analista en el Observatorio Social del Ministerio de Desarrollo Social (Diseño de encuestas y producción de estadísticas oficiales).
- Intereses: estratificación, desigualdad y sociología del trabajo.

<span class="tag" style="background-color:var(--quarto-hl-st-color)">r-project</span>
<br/>
<span class="tag" style="background-color:var(--quarto-hl-fu-color)">ciencia abierta</span>
<br/>
<span class="tag" style="background-color:var(--quarto-hl-dv-color)">estadística oficial</span>
...
::: {.column style="display:inline-block;width:40%;height:60%;border-radius:1em;margin:1%;padding:1.5%;background-color:#f5f5f5"}
<figure>
    <img src="/figures/people/ta_octopunian.png" alt="Foto de Felipe Adasme (Placeholder)" role="presentation" style="object-fit: cover;width:5em;height:5em;border-radius: 50%;font-size:1em;" class="img-responsive atto_image_button_text-bottom">
    <figcaption>
        <strong><span>Felipe Adasme</span></strong>
        <br/> 
        Licenciado en Sociología <br>
        📧 felipe.adasme@mail.udp.cl <br/>
    </figcaption>
</figure>
:::
...
::: {.column style="display:inline-block;width:40%;height:60%;border-radius:1em;margin:1%;padding:1.5%;background-color:#f5f5f5"}
<figure>
    <img src="/figures/people/ta_octopunian2.png" alt="Foto de Francisca Hernández (Placeholder)" role="presentation" style="object-fit: cover;width:5em;height:5em;border-radius: 50%;font-size:1em;" class="img-responsive atto_image_button_text-bottom">
    <figcaption>
        <strong><span>Francisca Hernández</span></strong>
        <br/> 
        Licenciada en Sociología <br>
        📧 francisca.hernandez_c@mail.udp.cl <br/>
    </figcaption>
</figure>
:::
...
## ¿Porque aprender y usar R? {.smaller background-color="white"}
...
## ¿Porque trabajar con código? {.smaller background-color="white"}
...
1.  **Editor de código**: formato de block de notas donde podemos construir nuestra código.
...
Boccardo, Giorgio y Ruiz, Felipe. Uso de RStudio para Estadística Univariada en Ciencias Sociales. Manual de apoyo docente para la asignatura Estadística Descriptiva. Santiago: Departamento de Sociología, Facultad de Ciencias Sociales, Universidad de Chile. [Disponible aquí.](link-a-reemplazar)

Grolemund, Garrett y Wickham Hadley. R para Ciencia de Datos. [https://es.r4ds.hadley.nz/](https://es.r4ds.hadley.nz/){preview-link="true"}

Paradis, E. (2003). R para Principiantes. Francia: Institut des Sciences de l'Évolution. Disponible en: [https://cran.r-project.org/doc/contrib/rdebuts_es.pdf](https://cran.r-project.org/doc/contrib/rdebuts_es.pdf){preview-link="true"}
...
Especialización en Ciencia de Datos Universidad John Hopkins [https://www.coursera.org/specializations/jhu-data-science](https://www.coursera.org/specializations/jhu-data-science){preview-link="true"}
