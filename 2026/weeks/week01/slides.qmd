...
| Ítem | Título | Autor | Año |
|:---|:---|:---|:---|
| 8 | [R para Ciencia de Datos](https://es.r4ds.hadley.nz/index.html) | Wickham, H. | 2019 |
...
::: {.callout-warning title="⚠️ Excepción: Prueba Solemne"}
Esta política **no aplica a la prueba solemne**, evaluación presencial e individual donde no está permitido el uso de IA.
:::
