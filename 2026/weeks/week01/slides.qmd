...
## 🤖 Política de Inteligencia Artificial (IA) {.smaller background-color="white"}

En sintonía con la ciencia de datos moderna y el reglamento UDP, adoptamos un **uso autorizado, transparente y delimitado** de IA Generativa (ChatGPT, Claude, Copilot).

::: {.callout-tip title="✅ Lo que SÍ está permitido (y fomentado)"}

:::

::: {.callout-important title="🚫 Lo que NO está permitido (Falta Ética)"}

:::

::: {.callout-warning title="📄 Anexo de Transparencia"}
...
- Las primeras semanas funcionarán como un **Bootcamp de nivelación en R** para quienes lo requieran tras la evaluación diagnóstica (Tarea 0).
- Posteriormente, acompañarán el progreso del curso resolviendo dudas de código, estimación de modelos y la preparación de los hitos del Trabajo Final.
:::
