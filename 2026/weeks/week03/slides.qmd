...
title: "<font style='font-size:1em;'>🗓️ Semana 03<br/> Fundamentos y la Necesidad de Diseños Complejos</font>"
...
## El Desafío: Conocer lo Social {.smaller}
...
## La Solución: Muestreo e Inferencia {.smaller}
...
-   **Fórmulas "simples"** para calcular:
    ...
    -   Errores estándar (SE), que miden la incertidumbre de nuestras estimaciones.
...
## Problema 1: Marcos Muestrales Incompletos {.smaller}
...
## Problema 2: Costos y Logística {.smaller}
...
<img src="img/02.jpg" alt="Mapa Chile con puntos dispersos" style="width: 50%; margin-top: 15px;"/>
<p style="font-size: 0.8em; margin-top: 5px;"><em>MAS puro implica una muestra muy dispersa geográficamente.</em></p>
</div>
```

## Problema 3: Representatividad de Subgrupos {.smaller}
...
## Estrategia 1: Estratificación {.smaller}
...
## Estratificación en CASEN {.smaller}
...
## Estrategia 2: Muestreo por Conglomerados {.smaller}
...
-   **Ejemplo Bi-etápico (Común en encuestas de hogares como CASEN):**
    ...
    -   *Dentro de cada vivienda seleccionada, se encuestan todos sus residentes sin selección adicional (recolección de datos, no una etapa de muestreo).*
-   **¿Por qué usar conglomerados?**
    -   **Reducción significativa de costos y logística**
...
## Conglomerados: La Contrapartida - Efecto de Diseño {.smaller}
...
## Conglomerados en CASEN {.smaller}
...
> El resultado es la ruptura del supuesto fundamental del MAS.

¿Cómo resolvemos esto para poder hacer inferencia válida?

## La Solución: Ponderadores (Factores de Expansión) {.smaller}
...
## Ponderadores: Ajustes Adicionales {.smaller}
...
## El Uso Correcto de los Ponderadores {.dark-background .smaller}
...
## El Impacto en el Análisis: ¿Por Qué Software Especial? {.smaller}
...
## La Necesidad de Herramientas Específicas {.smaller}
...
## El Rol de la Documentación de la Encuesta {.smaller}

Para poder usar `survey` o `srvyr`, necesitamos saber **cómo** se diseñó la muestra.

La **documentación técnica** de la encuesta (como el "Diseño Muestral Casen 2024") es **FUNDAMENTAL**. Nos dice:
...
-   Otros detalles técnicos del diseño (ej. número de etapas, corrección por población finita).

**Leer la documentación antes de analizar es indispensable.**

## Próximos Pasos {.smaller}

En el bloque práctico de hoy:

1.  **Cargaremos** la base de datos CASEN 2024.
